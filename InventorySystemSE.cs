...
//        tr.su =
//MONOSPACE_WIDTH;
//    jq = new tn(this, EnableDebug, n);
//    jq.qX = LCD_TAG;
//    jq.qY = SCROLL_LINES_PER_STEP;
//    jq.qZ = ENABLE_BOOT;
//    jq.q_ = BOOT_FRAMES;
//    jq.r0 =
//FORCE_REDRAW;
...
//        if (u > 0)
//        {
//            mB.ru(Math.Min(100, 100 * r / u), 0.3f);
//            mB.Add(' ' + q + ' ');
//            mB.rq(t8
//.nQ(r), 1.0f, jx);
//            mB.rm(" / " + t8.nQ(u));
//        }
//        else
//        { mB.Add(q + ':'); mB.rp(t8.nQ(r), 1.0f, jw); }
//    }
...
//            mB.rq(t8.nQ(w), 0.51f);
//            mB.Add(" / " + t8.nQ(y));
//            mB.rp("+" + t8.nQ(x) + " " + M.T["I1"], 1.0f);
//            mB.rt(Math.Min(100, 100 * w / y))
//;
//        }
//        else
//        { mB.Add(v + ':'); mB.rq(t8.nQ(w), 0.51f); mB.rp("+" + t8.nQ(x) + " " + M.T["I1"], 1.0f); }
//    }
...
//        { jC = 0; jB = 0; }
//        if (jC == 0)
//        { if ((jA = jJ.q6(B, z)) == null) return false; jC++; z = false; }
//        if (jA.Count > 0)
//        {
//            if (!A && !z
//)
...
//        {
//            if (!jO && !G)
//            { if (mB.rj.rG > 0 && mB.rj.rF[0] != "") mB.rm(""); mB.rr("<< " + M.T["I4"] + " " + M.T["I2"] + " >>"); }
//            for (
//; jF < jE.Count; jF++)
//            {
//                if (!s3.sp(40))
...
//                if (jN)
//                    I = jE[jF].q9;
//                var J = t8.nO(jE[jF].qb, jE[jF].qc);
//                if (jE[jF].qb != "Scrap")
//                { double K = jJ.q3(jE[jF].qb + " Ore", jE[jF].qb, "Ore").qe; jz(J, H, K, I); }
//                else
//                    jy(J
//, H, I);
//            }
...
//    {
//        jI.pp();
//        jL = mA.ol.EndsWith("x") || mA.ol.
//EndsWith("xs");
//        jM = mA.ol.EndsWith("s") || mA.ol.EndsWith("sx");
//        jN = mA.ol.StartsWith("missing");
//        jO = mA.ol.StartsWith("invlist");
//        jJ.pZ();
//        jK = mA.os;
//        if (jK.Count == 0)
//            jK.Add(new tb("all"));
...
//            else
//                L = false;
//            for (; jQ < N.oB.Count; jQ++)
//            {
//                if (!s3.sp(30))
//                    return false;
//                string[] P = N.oB[jQ].ToLower().Split(':');
//                double Q;
//                if (P[0] == "all")
//                    P[0] = "";
//                int R = 1;
...
//            if (!V)
//                jU = 0;
//            for (; jU < W.p5[jT].InventoryCount; jU++)
//            {
//                if (!V)
//                    jV = 0;
//                else
//                    V = false;
//                IMyInventory X = W.p5[jT].GetInventory(jU);
//                List<IMyInventoryItem> Y = X.GetItems();
//                for (; jV < Y.Count; jV++)
//                {
//                    if (!s3.sp(40))
//                        return false;
//                    IMyInventoryItem Z = Y[jV];
//                    var _ = t8.nM(Z);
//                    var a0 = _.ToLower();
//                    string a1, a2;
//                    t8.nN(a0, out a1, out a2);
//                    if (a2 == "ore")
//                    {
//                        if (jJ.q1(a1.ToLower(
//) + " ingot", a1, "Ingot") && jJ.q1(_, a1, a2))
//                            continue;
//                    }
//                    else
//                    { if (jJ.q1(_, a1, a2)) continue; }
//                    t8.nN(_, out a1, out a2);
//                    ti a3 = jJ.q3(a0, a1, a2);
//                    a3.
//qe += (double)Z.Amount;
//                }
//            }
...
//                    }
//                    else
//                    { if (!jH(a4)) return false; }
//                    break;
//                case 5:
//                    if (!jD(a4, jO, "Component", M.T["I5"]))
//                        return false;
//                    break;
//                case 6:
//                    if (!jD(a4,
//jO, "OxygenContainerObject", M.T["I6"]))
//                        return false;
//                    break;
//                case 7:
//                    if (!jD(a4, true, "GasContainerObject", ""))
//                        return false;
//                    break;
//                case 8:
//                    if (!jD(a4, jO, "AmmoMagazine", M.T["I7"]))
//                        return false;
//                    break;
//                case 9:
//                    if (!jD(a4, jO, "PhysicalGunObject", M.T["I8"]))
//                        return false;
//                    break;
//            }
//            a4 = false;
...
//            jZ = mA.ol
//.Contains("all");
//            j_ = (mA.ol[mA.ol.Length - 1] == 'x');
//            k0 = (mA.ol[mA.ol.Length - 1] == 'p');
//            k1 = 0;
//            k2 = 0;
//            k3 = 0;
//        }
...
//            }
//            else
//            { if (!jY.pn("cargocontainer", mA.om, a5)) return false; }
//            k3++;
//            a5 = false;
//        }
//        double a6 = jY.p7(ref k1, ref k2, a5);
//        if (
//Double.IsNaN(a6))
//            return false;
//        mB.Add(M.T["C2"] + " ");
//        if (!j_ && !k0)
//        {
//            mB.rp(t8.nQ(k1) + "L / " + t8.nQ(k2) + "L");
//            mB.ru(a6, 1.0f, mB.r4);
//            mB.rm(
//' ' + t8.nR(a6) + "%");
//        }
//        else if (k0)
//        { mB.rp(t8.nR(a6) + "%"); mB.rt(a6); }
//        else
//            mB.rp(t8.nR(a6) + "%");
//        return true;
//    }
...
//    {
//        if (!a7)
//        { k4.pp(); k5 = (mA.ol[mA.ol.Length - 1] == 'x'); k6 = (mA.ol[mA.ol.Length - 1] == 'p'); k7 = 0; }
//        if (k7 == 0)
//        {
//            if (!k4.pf(mA.om, a7
//))
...
//        {
//            double.
//TryParse(mA.os[0].oA.Trim(), out a9);
//            if (aa > 1)
//            {
//                var ab = mA.os[1].oA.Trim().ToLower();
//                if (ab != "")
//                    a9 *= Math.Pow(1000.0, "kmgtpezy".IndexOf(
//ab[0]));
//            }
//            a9 *= 1000.0;
//        }
...
//        if (ka == 0)
//        { if (!k9.pn("airvent", mA.om, ad)) return false; kc = (k9.pq() > 0); ka++; ad = false; }
//        if (ka == 1)
//        {
//            for (; kb < k9.
//pq(); kb++)
...
//                if (!s3.sp(8))
//                    return false;
//                IMyAirVent ae = k9.p5[kb] as IMyAirVent;
//                kg = Math.Max(ae.GetOxygenLevel() * 100, 0f);
//                mB.Add(ae.
//CustomName);
//                if (ae.CanPressurize)
//                    mB.rp(t8.nR(kg) + "%");
...
//s3.sp(4))
//                        return false;
//                    IMyOxygenFarm ag = k9.p5[kb] as IMyOxygenFarm;
//                    af += ag.GetOutput() * 100;
//                }
//                kg = af / kd;
//                if (kc)
...
//            if (!ad)
//                k9.pp();
//            if (!k9.pn("oxytank", mA.om, ad))
//                return false;
//            kd = k9.pq();
//            if (kd == 0)
//            { if (!kc) mB.rm(M.T["O3"]); return true; }
//            ka++;
//            ad = false;
//        }
//        if (ka == 5)
...
//        List<tb> aj = mA.os;
//        if (aj.Count == 0)
//        { mB.rm(M.T["T4"]); return true; }
//        if (!ah)
//        {
//            kk = (mA.ol.EndsWith("x") ? "s" : (mA.ol.EndsWith
//("p") ? "p" : (mA.ol.EndsWith("v") ? "v" : "n")));
//            kj = 0;
//            kl = aj[0].oA.Trim().ToLower();
//            ki.pp();
//            km = 0;
//            kn = 0;
//        }
...
//        }
//        if (kj == 1)
//        { if (!kh.qw(ki.p5, kl, ref km, ref kn, ah)) return false; ah = false; kj++; }
//        if (kn == 0)
//        {
//            mB.rm(String
//.Format(M.T["T5"], kl));
...
//        }
//        ko = km / kn * 100;
//        kl = char.ToUpper(kl[0]) + kl.Substring(1);
//        mB.Add(kl + " " + M.T["T6"]);
//        switch (kk)
//        {
//            case
...
//        }
//        if (ks == 0)
//        { if (!kq.pn("reactor", ak, an)) return false; an = false; ks++; }
//        if (ks == 1)
//        {
...
//                if (!s3.sp(6))
//                    return false;
//                IMyReactor at = kq.p5[kB] as IMyReactor;
//                if (at == null || !at.IsWorking)
//                    continue;
//                if (at.Components.TryGet<
//MyResourceSourceComponent>(out ao))
//                { ku += ao.CurrentOutputByType(mB.rc.qo); kv += ao.MaxOutputByType(mB.rc.qo); }
//                kt += (double)at.
...
//        }
//        if (ks == 2)
//        { if (!kr.pn("battery", ak, an)) return false; an = false; ks++; }
//        if (ks == 3)
//        {
//            if (!an)
//                kB = 0
...
//                if (!s3.sp(15))
//                    return false;
//                IMyBatteryBlock at = kr.p5[kB] as IMyBatteryBlock;
//                if (at == null || !at.IsWorking)
//                    continue;
//                if (at.Components.TryGet<MyResourceSourceComponent>(out ao))
//                {
//                    kx = ao.CurrentOutputByType(mB.rc.qo);
//                    ky = ao.MaxOutputByType(mB.
//rc.qo);
//                }
//                if (at.Components.TryGet<MyResourceSinkComponent>(out ap))
//                { kx -= ap.CurrentInputByType(mB.rc.qo); }
//                double au = (kx < 0 ? (at.
//MaxStoredPower - at.CurrentStoredPower) / (-kx / 3600) : 0);
//                if (au > ar.kP)
//                    ar.kP = au;
//                if (at.GetValueBool("Recharge"))
//                    continue;
//                kz += kx;
//                kA += ky;
//                kw
...
//        double av = ku + kz;
//        if (av <= 0)
//            ar.kO = TimeSpan.FromSeconds(-1);
//        else
//        {
//            double aw = ar.kO.TotalSeconds;
//            double ax;
//            double ay = (ar.kQ - kt) / aq;
//            if (ku <= 0)
//                ay = Math.Min(av, kv) / 3600000;
//            double az = 0;
//            if (kA > 0)
//                az = Math.Min(av, kA) / 3600;
//            if (ay <= 0 && az <= 0)
//                ax = -1;
//            else if (ay <= 0)
//                ax = kw / az;
...
//                ax = kt / ay;
//            else
//            { double aA = az; double aB = (ku <= 0 ? av / 3600 : ay * av / ku); ax = kw / aA + kt / aB; }
//            if (aw <= 0
//|| ax < 0)
//                aw = ax;
//            else
//                aw = (aw + ax) / 2;
//            try
//            { ar.kO = TimeSpan.FromSeconds(aw); }
//            catch { ar.kO = TimeSpan.FromSeconds(-1); }
//        }
//        ar.kQ = kt;
//        am = ar.kP;
//        al = ar.
...
//        if (aD.Ticks <= 0)
//            return "-";
//        if ((int)aD.TotalDays > 0)
//            aE += (long)aD.TotalDays + " " + M.T[
//"C5"] + " ";
//        if (aD.Hours > 0 || aE != "")
//            aE += aD.Hours + "h ";
//        if (aD.Minutes > 0 || aE != "")
//            aE += aD.Minutes + "m ";
//        return aE + aD.Seconds + "s";
//    }
//    int kE = 0;
...
//        if (!
//aF)
//        { kF = (mA.ol[mA.ol.Length - 1] == 'x'); kG = (mA.ol[mA.ol.Length - 1] == 'p'); kE = 0; kJ = kK = kL = kM = 0; kN = 0; kH = 0; }
//        if (kE == 0)
//        {
//            if (mA.os.Count > 0)
//            {
...
//                        return false;
//                    mA.os[kN].oC();
//                    if (mA.os[kN].oB.Count <= 0)
//                        continue;
//                    var aG = mA.os[kN].oB[0];
//                    int.
//TryParse(aG, out kM);
//                    if (kN == 0)
//                        kJ = kM;
...
//        }
//        string aJ;
//        if (kI.TotalSeconds > 0 || kH <= 0)
//        { mB.Add(M.T["PT1"] + " "); aJ = kD(kI); aH = kI.TotalSeconds; }
//        else
//        {
//            mB.Add(
//M.T["PT2"] + " ");
//            aJ = kD(TimeSpan.FromSeconds(kH));
//            if (aI.TotalSeconds >= kH)
//                aH = aI.TotalSeconds - kH;
//            else
//                aH = 0;
//        }
//        if (aI.Ticks <= 0)
...
//            return true;
//        }
//        double aK = aH / aI.TotalSeconds * 100;
//        if (aK > 100)
//            aK = 100;
//        if (!kF && !kG)
//        {
...
//        }
//        else if (kG)
//        { mB.rp(aK.ToString("0.0") + "%"); mB.rt(aK); }
//        else
//            mB.rp(aK.ToString("0.0") + "%");
//        return true;
//    }
//}
//class sG : t1
...
//    {
//        double aN = (aM > 0 ? aL / aM * 100 : 0);
//        switch (kT)
//        {
//            case "s":
//                mB.rp(aN.ToString("0.0") + "%", 1.0f);
//                break;
//            case "v":
//                mB.rp(t8.nQ(aL) + "W / " + t8.nQ(aM) + "W", 1.0f);
//                break;
//            case "c":
//                mB.rp(t8.nQ(aL) + "W", 1.0f);
//                break;
//            case "p":
//                mB.rp(aN.ToString(
//"0.0") + "%", 1.0f);
...
//                break;
//            default:
//                mB.rp(t8.nQ(aL) + "W / " + t8.nQ(aM) + "W");
//                mB.ru(aN, 1.0f, mB.r4);
//                mB.rp(' ' + aN.ToString("0.0") +
//"%");
//                break;
//        }
//    }
...
//        {
//            kT = (mA.ol.EndsWith("x"
//) ? "s" : (mA.ol.EndsWith("usedp") || mA.ol.EndsWith("topp") ? "p" : (mA.ol.EndsWith("v") ? "v" : (mA.ol.EndsWith("c") ? "c" : "n"))));
//            kU = (mA.ol.
//Contains("top") ? "top" : "");
//            kV = (mA.os.Count > 0 ? mA.os[0].oA : M.T["PU1"]);
//            kX = kY = 0;
//            k_ = 0;
//            kZ = 0;
//            kS.pp();
...
//                        if (!s3.sp(20))
//                            return false;
//                        IMyTerminalBlock aR = kS.p5[kZ];
//                        if (aR.Components.TryGet<MyResourceSinkComponent>(out aP))
...
//                }
//                if (l0.l3() <= 0)
//                { mB.rm("PowerUsedTop: " + M.T["D2"]); return true; }
//                int aT = 10;
//                if (mA.os.Count > 0)
//                    if (
//!int.TryParse(kV, out aT))
//                    { aT = 10; }
//                if (aT > l0.l3())
//                    aT = l0.l3();
//                if (k_ == 2)
...
//.sp(30))
//                            return false;
//                        IMyTerminalBlock aR = l0.l4(kZ);
//                        var aU = tr.sx(aR.CustomName, tn.qV * 0.4f * mB.rj.rA);
//                        if (aR.Components.TryGet<
//MyResourceSinkComponent>(out aP))
//                        { kX = aP.CurrentInputByType(kR.qo) * 0xF4240; kY = aP.MaxRequiredInputByType(kR.qo) * 0xF4240; }
//                        mB.Add(aU +
//" ");
//                        kW(kX, kY);
//                    }
...
//                    {
//                        ListReader<MyDefinitionId> aS = aP.AcceptedResources;
//                        if (aS.IndexOf(kR.qo) < 0)
//                            continue;
//                        aV = aP.CurrentInputByType(kR.qo);
//                        kY += aP.MaxRequiredInputByType(kR.qo);
//                    }
//                    else
//                        continue;
//                    if (aR.Components.TryGet<
//MyResourceSourceComponent>(out aQ) && (aR as IMyBatteryBlock != null))
//                    { aV -= aQ.CurrentOutputByType(kR.qo); if (aV <= 0) continue; }
//                    kX += aV;
//                }
//                mB
//.Add(kV);
//                kW(kX * 0xF4240, kY * 0xF4240);
//                break;
//        }
//        return true;
//    }
...
//        {
//            lc = (mA.ol.
//EndsWith("x") ? "s" : (mA.ol.EndsWith("p") ? "p" : (mA.ol.EndsWith("v") ? "v" : "n")));
//            ld = (mA.ol.StartsWith("powersummary"));
//            le = "a";
//            lg = "";
//            if (
//mA.ol.Contains("stored"))
//                le = "s";
//            else if (mA.ol.Contains("in"))
//                le = "i";
//            else if (mA.ol.Contains("out"))
//                le = "o";
//            li = 0;
//            l8.pp();
//            l9.pp();
...
//        {
//            if (li == 0)
//            { if (!l8.pn("reactor", mA.om, b3)) return false; b3 = false; li++; }
//            if (li == 1)
//            {
...
//            li = 2;
//        if (li == 2)
//        { if (!la.pn("battery", mA.om, b3)) return false; b3 = false; li++; }
//        int b4 = l8.pq()
//;
//        int b5 = l9.pq();
//        int b6 = la.pq();
...
//                lh++;
//            if (lh < 1)
//            { mB.rm(M.T["P6"]); return true; }
//            if (mA.
//os.Count > 0)
//            { if (mA.os[0].oA.Length > 0) lg = mA.os[0].oA; }
//            li++;
//            b3 = false;
//        }
//        if (le != "a")
//        {
//            if (!lw(la, (lg == "" ? M.T["P7"] : lg), le, lc, b3))
//                return
//false;
//            return true;
//        }
...
//        {
//            if (li == 4)
//            { if (b4 > 0) if (!lo(l8, (lg == "" ? M.T["P9"] : lg), lc, b3)) return false; li++; b3 = false; }
//            if (li == 5)
//            { if (b5 > 0) if (!lo(l9, (lg == "" ? M.T["P10"] : lg), lc, b3)) return false; li++; b3 = false; }
//            if (li == 6)
//            {
//                if (b6 > 0)
//                    if (!lw(la, (lg == "" ? M.T["P7"
...
//        {
//            case "s":
//                mB.rp(' ' + ba.ToString("0.0") + "%");
//                break;
//            case "v":
//                mB.rp(t8.nQ(b8) + "W / " + t8.nQ(b9) + "W");
//                break;
//            case "c":
//                mB.rp(t8
//.nQ(b8) + "W");
...
//        { ll = 0; lm = 0; ln = 0; }
//        if (ln == 0)
//        { if (!l7.qu(bb.p5, l7.qo, ref lk, ref lk, ref ll, ref lm, be)) return false; ln++; be = false; }
//        if (!
//s3.sp(50))
//            return false;
//        double bf = (lm > 0 ? ll / lm * 100 : 0);
//        mB.Add(bc + ": ");
//        lj(ll * 0xF4240, lm * 0xF4240);
//        return true;
//    }
...
//    {
//        if (!bk)
//        { lp = lq = 0; lr = ls = 0; lt = lu = 0; lv = 0; }
//        if (lv == 0
//)
//        {
//            if (!l7.qs(bg.p5, ref lr, ref ls, ref lp, ref lq, ref lt, ref lu, bk))
//                return false;
//            lr *= 0xF4240;
//            ls *= 0xF4240;
//            lp *= 0xF4240;
...
//            bk = false;
//        }
//        double bl = (lu > 0 ? lt / lu * 100 : 0);
//        double bm = (lq > 0 ? lp / lq * 100 : 0);
//        double bn = (ls > 0 ? lr / ls * 100 : 0);
//        var bo =
//bi == "a";
//        if (lv == 1)
//        {
...
//                {
//                    mB.Add(bh + ": ");
//                    mB.rp("(IN " + t8.nQ(lr) + "W / OUT " + t8.nQ(lp) + "W)");
//                }
//                else
//                    mB.rm(bh + ": ");
//                mB.Add("  " + M.T["P3"] + ": ");
...
//                        break;
//                    case "v":
//                        mB.rp(t8.nQ(lt) + "Wh / " + t8.nQ(lu) + "Wh");
//                        break;
//                    case "p":
//                        mB.rp(' ' + bl.ToString("0.0") + "%");
//                        mB.rt(bl);
//                        break;
//                    default:
//                        mB.rp(t8.nQ(lt) + "Wh / " + t8.nQ(lu) + "Wh");
...
//                    case
//"s":
//                        mB.rp(' ' + bm.ToString("0.0") + "%");
//                        break;
//                    case "v":
//                        mB.rp(t8.nQ(lp) + "W / " + t8.nQ(lq) + "W");
//                        break;
//                    case "p":
//                        mB.rp(' ' + bm.ToString(
//"0.0") + "%");
...
//            {
//                case "s":
//                    mB.rp(' ' + bn.ToString("0.0") + "%");
//                    break;
//                case "v":
//                    mB.rp(t8.nQ(lr) + "W / " + t8.nQ(ls) + "W");
//                    break;
//                case "p":
//                    mB.rp(' ' + bn.
//ToString("0.0") + "%");
...
//        double br = 1;
//        var bs = "m/s";
//        if (mA.ol.Contains("kmh"))
//        { br = 3.6; bs = "km/h"; }
//        else if (mA.ol.Contains("mph"))
//        { br = 2.23694; bs = "mph"; }
//        if (mA.om
//!= "")
//            double.TryParse(mA.om.Trim(), out bq);
//        mB.Add(M.T["S1"] + " ");
//        mB.rp((mB.re.oH * br).ToString("F1") + " " + bs + " ");
//        if (bq > 0)
//            mB.rt(mB.re
//.oH / bq * 100);
//        return true;
...
//        if (mA.om
//!= "")
//            double.TryParse(mA.om.Trim(), out bu);
//        mB.Add(M.T["AC1"] + " ");
//        mB.rp(mB.re.oJ.ToString("F1") + " m/s²");
//        if (bu > 0)
//        {
//            double bv = mB.re.
//oJ / bu * 100;
...
//                return false;
//            if (lx.pq() <= 0)
//            { mB.rm("Charge: " + M.T["D2"]); return true; }
//            ly++;
//            by = false;
//        }
//        for (; lz < lx.pq(); lz++)
...
//(!s3.sp(25))
//                return false;
//            IMyJumpDrive bA = lx.p5[lz] as IMyJumpDrive;
//            double bB, bC, bD;
//            bD = tf.pE(bA, out bB, out bC);
//            mB.Add(bA.CustomName)
//;
//            if (!bz)
//            { mB.rp(t8.nQ(bB) + "Wh / " + t8.nQ(bC) + "Wh"); mB.ru(bD, 1.0f, mB.r4); }
...
//    {
//        var bF = (mA.ol.StartsWith("datetime"));
//        var bG = (mA.ol.
//StartsWith("date"));
//        var bH = mA.ol.Contains("c");
//        int bI = mA.ol.IndexOf('+');
//        if (bI < 0)
//            bI = mA.ol.IndexOf('-');
//        float bJ = 0;
//        if (bI >= 0)
//            float.
//TryParse(mA.ol.Substring(bI), out bJ);
//        DateTime bK = DateTime.Now.AddHours(bJ);
//        var bL = "";
//        int bM = mA.on.IndexOf(' ');
//        if (bM >= 0)
//            bL = mA.on.
//Substring(bM + 1);
//        if (!bF)
//        { if (!bG) bL += bK.ToShortTimeString(); else bL += bK.ToShortDateString(); }
//        else
//        {
//            if (bL == "")
//                bL = String.Format(
...
//!= "*")
//        {
//            IMyTextPanel bZ = mB.rf.GetBlockWithName(mA.om) as IMyTextPanel;
//            if (bZ == null)
//            { mB.rm("TextLCD: " + M.T["T1"] + mA.om); return true; }
//            bY = bZ.GetPublicText();
//        }
//        else
//        { mB.rm("TextLCD:" + M.T["T2"]); return true; }
//        if (bY.Length == 0)
//            return true;
//        mB.rn(bY);
//        return true;
...
//    {
//        if (!b_)
//        { lB = (mA.ol == "enabledcount"); lC = (mA.ol == "prodcount"); lD = 0; lE = 0; }
//        if (mA.os.Count == 0)
//        {
//            if (
//lE == 0)
//            { if (!b_) lA.pp(); if (!lA.pf(mA.om, b_)) return false; lE++; b_ = false; }
//            if (!lO(lA, "blocks", lB, lC, b_))
//                return false;
//            return true;
//        }
//        for (;
//lD < mA.os.Count; lD++)
//        { tb c0 = mA.os[lD]; if (!b_) c0.oC(); if (!lH(c0, b_)) return false; b_ = false; }
//        return true;
//    }
...
//                if (!c2)
//                    lA.pp();
//                if (!lA.pn(c1.oB[lF], mA.om, c2))
//                    return false;
//                lG++;
//                c2 = false;
//            }
//            if (!lO(lA, c1.oB[lF], lB, lC, c2))
//                return false;
//            lG = 0;
//            c2 = false;
//        }
...
//        {
//            c8 = c4.ToLower();
//            c8 = char.ToUpper(c8[0]) + c8.Substring(1).ToLower()
//;
//            mB.Add(c8 + " " + M.T["C1"] + " ");
//            var c9 = (c5 || c6 ? "0 / 0" : "0");
//            mB.rp(c9);
...
//                if (!s3.sp(15))
//                    return false;
//                IMyProductionBlock ca = c3.p5[lL] as IMyProductionBlock;
//                c8 = c3.p5[
//lL].DefinitionDisplayNameText;
//                if (lK.Contains(c8))
//                { lI[c8]++; if ((c5 && c3.p5[lL].IsWorking) || (c6 && ca != null && ca.IsProducing)) lJ[c8]++; }
//                else
//                {
//                    lI.Add(c8, 1);
//                    lK.Add(c8);
//                    if (c5 || c6)
//                        if ((c5 && c3.p5[lL].IsWorking) || (c6 && ca != null && ca.IsProducing))
//                            lJ.Add(c8, 1);
//                        else
//                            lJ.Add(c8, 0)
//;
...
//        if (!cc)
//            lP.pp();
//        if (!lP.pn("shipctrl", mA.om, cc))
//            return false;
//        if (lP.pq() <= 0)
//        {
//            if (mA.om != "" && mA.om != "*")
//                mB.rm(mA.ol + ": " + M.T["SC1"] + " (" + mA.om + ")");
//            else
//                mB.rm(mA.ol + ": " + M.T["SC1"]);
//            return true;
//        }
//        if (mA.ol.
//StartsWith("damp"))
//        { var cd = (lP.p5[0] as IMyShipController).DampenersOverride; mB.Add(M.T["SCD"]); mB.rp(cd ? "ON" : "OFF"); }
//        else
//        {
//            var cd = (
//lP.p5[0] as IMyShipController).IsUnderControl;
//            mB.Add(M.T["SCO"]);
//            mB.rp(cd ? "YES" : "NO");
//        }
//        return true;
...
//                        continue;
//                    lQ.pp();
//                    lW = ch.oB[lV].ToLower().Split(':');
//                    lX = lW[0];
//                    lY = (lW.
//Length > 1 ? lW[1] : "");
//                }
//                if (lX != "")
//                { if (!lQ.pn(lX, mA.om, ci)) return false; }
//                else
//                { if (!lQ.pf(mA.om, ci)) return false; }
//                lU++;
//                ci = false;
//            }
//            if (!m1(
...
//        if (!cj.IsWorking)
//            return M.T["W1"];
//        IMyProductionBlock ck = cj as IMyProductionBlock;
//        if (ck != null)
//            if (ck.IsProducing)
//                return M.T["W2"];
//            else
...
//cj as IMyAirVent;
//        if (cl != null)
//        { if (cl.CanPressurize) return (cl.GetOxygenLevel() * 100).ToString("F1") + "%"; else return M.T["W4"]; }
//        IMyGasTank cm = cj as IMyGasTank;
//        if (cm != null)
//            return (cm.FilledRatio * 100).ToString("F1") + "%";
//        IMyBatteryBlock cn = cj as IMyBatteryBlock;
//        if (cn != null)
//            return tf.pC(cn);
//        IMyJumpDrive co = cj as IMyJumpDrive;
//        if (co != null)
//            return tf.pF(co).ToString("0.0") + "%";
//        IMyLandingGear cp
//= cj as IMyLandingGear;
//        if (cp != null)
//            return tf.pG(cp);
//        IMyDoor cq = cj as IMyDoor;
//        if (cq != null)
//        {
//            if (cq.Status == DoorStatus.Open)
//                return M.T[
//"W5"];
//            return M.T["W6"];
//        }
//        IMyShipConnector cr = cj as IMyShipConnector;
//        if (cr != null)
//        {
//            if (cr.Status == MyShipConnectorStatus.Unconnected)
//                return M.T["W8"];
//            if (cr.Status == MyShipConnectorStatus.Connected)
//                return M.T["W7"];
//            else
//                return M.T["W10"];
//        }
...
//        if (cs != null)
//            return tf.pD(cs);
//        IMyRadioAntenna cu = cj as IMyRadioAntenna;
//        if (cu != null)
//            return t8.nQ(cu.Radius) + "m";
//        IMyBeacon cv = cj as IMyBeacon;
//        if (cv != null)
//            return t8.nQ(cv.Radius) + "m";
//        return M.T["W9"];
//    }
...
//            if (!s3.sp(20))
//                return false;
//            IMyTerminalBlock cA = cw.p5[m0];
//            var cB = (cx ? (cA.IsWorking ? M.T[
//"W9"] : M.T["W1"]) : l_(cA));
//            if (cy != "" && cB.ToLower() != cy)
//                continue;
//            if (cx)
//                cB = l_(cA);
//            var cC = cA.CustomName;
//            cC = tr.sx(cC, tn.qV * 0.7f * mB.rj.rA
//);
//            mB.Add(cC);
//            mB.rp(cB);
//        }
...
//    {
//        var cE = mA.ol.StartsWith("damagex");
//        var cF = mA.ol.EndsWith(
//"noc");
//        var cG = (!cF && mA.ol.EndsWith("c"));
//        float cH = 100;
//        if (!cD)
//        { m2.pp(); m3 = false; m4 = 0; }
//        if (!m2.pf(mA.om, cD))
...
//        if (mA.os.
//Count > 0)
//        { if (!float.TryParse(mA.os[0].oA, out cH)) cH = 100; }
//        for (; m4 < m2.pq(); m4++)
//        {
//            if (!s3.sp(30))
//                return false;
//            IMyTerminalBlock cI = m2.p5
//[m4];
//            IMySlimBlock cJ = cI.CubeGrid.GetCubeBlock(cI.Position);
//            if (cJ == null)
//                continue;
//            float cK = (cF ? cJ.MaxIntegrity : cJ.BuildIntegrity);
//            if
//(!cG)
//                cK -= cJ.CurrentDamage;
//            float cL = 100 * (cK / cJ.MaxIntegrity);
//            if (cL >= cH)
//                continue;
//            m3 = true;
//            mB.Add(tr.sx(cJ.FatBlock.DisplayNameText, tn
//.qV * 0.69f * mB.rj.rA - 70) + " ");
//            if (!cE)
//            { mB.rq(t8.nQ(cK) + " / ", 0.69f); mB.Add(t8.nQ(cJ.MaxIntegrity)); }
...
//            if (mA
//.os.Count == 0)
//                mA.os.Add(new tb("reactor,gatlingturret,missileturret,interiorturret,gatlinggun,launcherreload,launcher,oxygenerator"
//   ));
//            m8 = 0;
//        }
...
//            }
//            var cR = M.T["A1"];
//            var cS = mg.CustomName;
//            if (mc > 0 && (double)mh.
//CurrentVolume > 0)
//            {
//                double cT = me * (double)mh.CurrentVolume / (mc + me);
//                md = Math.Floor(mc * ((double)mh.MaxVolume - cT) / (double)mh.CurrentVolume
//- cT);
//                cR = t8.nQ(mc) + " / " + (me > 0 ? "~" : "") + t8.nQ(md);
//            }
//            cS = tr.sx(cS, tn.qV * 0.8f * mB.rj.rA);
//            mB.Add(cS);
//            mB.rp(cR);
//            if (m6 && md > 0)
//            {
...
//        var cW = (mA.ol == "posxyz");
//        var cX = (mA.ol == "posgps");
//        IMyTerminalBlock cY = mC.mT.qA;
//        if (mA.om != "" && mA.om != "*")
//        {
//            cY = mB.rf.
//GetBlockWithName(mA.om);
//            if (cY == null)
//            { mB.rm("Pos: " + M.T["P1"] + ": " + mA.om); return true; }
//        }
//        if (cX)
//        {
...
//        mB.Add(M.T["P2"] + ": ");
//        if (!cW)
//        { mB.rp(cY.GetPosition().ToString("F0")); return true; }
//        mB.rm("");
//        mB.Add(" X: ");
//        mB.rp(cY.
//GetPosition().GetDim(0).ToString("F0"));
//        mB.Add(" Y: ");
//        mB.rp(cY.GetPosition().GetDim(1).ToString("F0"));
//        mB.Add(" Z: ");
//        mB.rp(cY.
//GetPosition().GetDim(2).ToString("F0"));
//        return true;
//    }
//}
//class sW : t1
...
//    {
//        if (mA.om == "" || mA.om == "*")
//        { mB.rm("Details: " + M.T["D1"]); return true; }
//        if (!c_)
//        { mm.pp(); mn = 0; mo = 1; }
//        if (mn
//== 0)
//        { if (!mm.pf(mA.om, c_)) return true; if (mm.pq() <= 0) { mB.rm("Details: " + M.T["D2"]); return true; } mn++; c_ = false; }
//        int d0 = (mA.ol.
//EndsWith("x") ? 1 : 0);
//        if (mn == 1)
//        { if (!c_) { mp = mm.p5[0]; mB.rm(mp.CustomName); } if (!mt(mp, d0, c_)) return false; mn++; c_ = false; }
//        for (; mo < mm.pq(
//); mo++)
//        { if (!c_) { mp = mm.p5[mo]; mB.rm(""); mB.rm(mp.CustomName); } if (!mt(mp, d0, c_)) return false; c_ = false; }
//        return true;
//    }
//    string[] mq; int
...
//    {
//        var
//d5 = mA.ol.EndsWith("base");
//        double d6 = 0;
//        if (mA.om != "")
//            double.TryParse(mA.om.Trim(), out d6);
//        int d7 = mA.os.Count;
//        if (d7 > 0)
//        {
//            var d8 = mA.os[0
//].oA.Trim().ToLower();
//            if (d8 != "")
//                d6 *= Math.Pow(1000.0, "kmgtpezy".IndexOf(d8[0]));
//        }
//        double d9 = (d5 ? mB.re.oR : mB.re.oQ);
//        if (!d5)
//            mB.Add(M.T
//["SM1"] + " ");
//        else
//            mB.Add(M.T["SM2"] + " ");
//        mB.rp(t8.nQ(d9, true, 'k') + "g ");
//        if (d6 > 0)
//            mB.rt(d9 / d6 * 100);
//        return true;
//    }
...
//        mu = mA.os[0].oA.Trim();
//        mv = mu.Split(':');
//        if (mv.Length < 5 || mv[0] != "GPS")
//            return;
//        double da, db, dc;
//        if (!double.
//TryParse(mv[2], out da))
//            return;
//        if (!double.TryParse(mv[3], out db))
//            return;
//        if (!double.TryParse(mv[4], out dc))
//            return;
//        mw = new Vector3D(da
//, db, dc);
//        mx = mv[1];
...
//    {
//        if (!my)
//        { mB.rm("Distance: " + M.T["DTU"] + " '" + mu + "'."); return true; }
//        IMyTerminalBlock de = mC.mT.qA;
//        if (mA.om != "" && mA.om != "*")
//        {
//            de = mB.rf.GetBlockWithName(mA.om);
//            if (de == null)
//            {
...
//            }
//        }
//        double df = Vector3D.Distance(de.GetPosition(), mw);
//        mB.Add(mx + ": ");
//        mB.rp(t8.nQ(df) + "m ");
//        return true;
//    }
...
//    {
//        double dj = 0;
//        if (mA.ol.Contains("best"))
//            dj = mB.re.oH / mB.re.oL;
//        else
//            dj = mB.re.oH / mB.re.oO;
//        double dk = mB.re.oH / 2 * dj;
//        if (mA.ol.Contains(
//"time"))
//        {
//            mB.Add(M.T["ST"]);
...
//            try
//            {
//                TimeSpan dm = TimeSpan.FromSeconds(dj);
//                if ((
//int)dm.TotalDays > 0)
//                    dl = " > 24h";
//                else
...
//        }
//        mB.Add(M.T["SD"]);
//        if (!double.IsNaN(dk) && !double.IsInfinity(dk))
//            mB.rp(t8.nQ(dk) + "m ");
//        else
//            mB.rp("N/A");
//        return true;
...
//    {
//        var dp = (mA.ol.
//Contains("nat") ? "n" : (mA.ol.Contains("art") ? "a" : (mA.ol.Contains("tot") ? "t" : "s")));
//        Vector3D dq;
//        switch (dp)
//        {
//            case "n":
//                mB.Add(M.T["G2"] +
//" ");
//                dq = mB.re.oY.GetNaturalGravity();
//                mB.rp(dq.Length().ToString("F1") + " m/s²");
//                break;
//            case "a":
//                mB.Add(M.T["G3"] + " ");
//                dq = mB.re.oY.
...
//                mB.Add("");
//                dq = mB.re.oY.GetNaturalGravity();
//                mB.rq(dq.Length().ToString("F1") + " | ", 0.33f);
//                dq = mB.re.oY.
//GetArtificialGravity();
//                mB.rq(dq.Length().ToString("F1") + " | ", 0.66f);
//                dq = mB.re.oY.GetTotalGravity();
//                mB.rp(dq.Length().ToString("F1"
//) + " ");
//                break;
//        }
//        return true;
...
//                return false;
//            if (mL.os.Count > 0)
//            { if (!int.TryParse(mL.os[0].oA, out mH)) mH = 1; else if (mH < 1) mH = 1; }
//            if (mL.ol.EndsWith("up")
//)
//                mH = -mH;
//            else if (!mL.ol.EndsWith("down"))
//                mH = 0;
//            mK++;
//            dy = false;
//        }
//        if (mK == 1)
//        { if (!mI.pn("textpanel", mL.om, dy)) return false; mK++; dy = false; }
//        tl dz;
//        for (; mJ < mI.pq(); mJ++)
//        {
//            if (!s3.sp(20))
//                return false;
//            IMyTextPanel dA = mI.p5[mJ] as IMyTextPanel;
//            if (!mE.nt.TryGetValue(dA, out dz))
//                continue;
//            if (dz == null || dz.qA != dA)
//                continue;
//            if (dz.qE)
...
//    {
//        t7 dH = mN.np;
//        for (int dI = 0; dI < dH.nG(); dI++)
//        {
//            tl dJ = dH.nI(dI);
//            mM
//.rk(dJ.qz, dJ);
//            mM.rv();
//            if (dJ.qA.GetValueFloat("FontSize") > 3f)
//                continue;
//            mM.rr(M.T["B1"]);
//            double dK = (double)mO / mM.q_.Count * 100;
//            mM.rt(
//dK);
//            if (mO == mM.q_.Count)
//            { mM.rm(""); mM.rr("Automatic LCDs 2"); mM.rr("by MMaster"); }
//            else
//                mM.rn(mM.q_[mO]);
//            mM.rw(dJ);
//        }
...
//            char[] dS = { ';', '\n' };
//            var dT = n2.Replace("\\;", "\f");
//            n6 = new List<string>(dT.Split(dS, StringSplitOptions.RemoveEmptyEntries
//));
//            n7.Clear();
//            n4 = 0;
//            n5 = 0;
...
//                continue;
//            }
//            n6[n4] = n6[n4].Replace('\f', ';');
//            if (!mW.ContainsKey(n6[n4]))
//            {
//                if (n8 != 1)
//                    dR = false;
//                n8 = 1;
...
//                if (!s3.sp(7))
//                    return false;
//                if (!n7.Contains(mX[n5]))
//                    if (mW.TryGetValue(mX[n5], out dV))
//                    { dV.s7(); mW.Remove(mX[n5]); }
//                n5++;
//            }
//        }
//        mX = n6;
...
//    {
//        if (mX != null)
//        { t1 dW; for (int dX = 0; dX < mX.Count; dX++) { if (mW.TryGetValue(mX[dX], out dW)) dW.s7(); } mX = null; }
//        if (mU !=
//null)
//        { mU.s7(); mU = null; }
//    }
...
//        if (!dY)
//        {
//            mT.qz = mS.rk(mT.qz, mT);
//            n3();
//            if (mT.qA.CustomName != na)
//                nb = true;
//            else
//                nb = false;
//            na = mT.qA.CustomName;
...
//                return false;
//            if (n2 == "")
//            { if (mY.nu) { mS.rv(); mS.rm(M.T["H1"]); mS.rw(mT); return true; } return this.s5(2); }
//            nb = true;
//        }
//        mV = n2;
//        if (mU != null && nb)
...
//    {
//        t1 e0;
//        if (!d_ && (!ne.mZ || ne.mX == null || ne.mX.Count <= 0))
//            return true;
//        if (ne.mY.nn > 5)
//            return s5(0);
//        if (!d_)
//        { ni = 0; nj = false; nk = double.MaxValue; nl = 0; }
//        if (nl == 0)
//        {
...
//)
//                    return false;
//                if (ne.mW.TryGetValue(ne.mX[ni], out e0))
//                {
//                    if (!e0.s1)
//                        return s5(e0.rX - s3.sb + 0.001);
//                    if (e0.rY > nf)
//                        nj = true;
//                    if (e0.rX < nk)
//                        nk = e0
...
//                var e2
//= nd.qA.CustomName;
//                e2 = (e2.Contains("#") ? e2.Substring(e2.LastIndexOf('#') + 1) : "");
//                if (e2 != "")
//                    nc.rm(e2);
//                nh = 0;
...
//!s3.sp(7))
//                    return false;
//                if (!ne.mW.TryGetValue(ne.mX[nh], out e0))
//                { nc.rm("ERR: No cmd task (" + ne.mX[nh] + ")"); nh++; continue; }
//                nc.ro(e0.
//mz.rM());
//                nh++;
//            }
...
//        if (nw == 1)
//        {
//            if (no.qX == "T:[LCD]" && "T:!LCD!" != "")
//                if (!nq.pn("textpanel", "T:!LCD!", e4))
//                    return false;
//            nw++;
//            e4 = false;
//        }
...
//        {
//            t4 e8;
//            if (ns.TryGetValue(e7, out e8))
//            { np.nJ(e7.qD); ns.Remove(e7); e8.s7(); }
//        }
//    }
...
//            if (!s3.sp(20))
//                return false;
//            IMyTextPanel ea = (nq.p5[nA] as IMyTextPanel);
//            if (ea == null || !ea.IsWorking)
//            { nq.p5.RemoveAt(nA); continue; }
//            tl eb = null;
//            var ec = false;
//            var ed = ny(ea);
//            int ee = ed.IndexOf("!LINK:");
//            if (ee >=
//0 && ed.Length > ee + 6)
//            { ed = ed.Substring(ee + 6); ec = true; }
//            if (nt.ContainsKey(ea))
//            { eb = nt[ea]; if (eb.qD == ed) { nA++; continue; } this.nz(ea); }
//            if (!
//ec)
//            { eb = new tl(no, ed); eb.qy.qM(ed, ea); t4 ef = new t4(this, eb); s3.sh(ef, 0); ns.Add(eb, ef); np.nF(ed, eb); nt.Add(ea, eb); nA++; continue; }
//            string[] eg = ed.Split(' ');
//            var eh = eg[0];
//            eb = np.nH(eh);
//            if (eb == null)
...
//            if (!s3.sp(300))
//                return false;
//            IMyTextPanel ea = nr.p5[nB] as
//IMyTextPanel;
//            if (ea == null)
//                continue;
//            if (!nq.p5.Contains(ea))
//                this.nz(ea);
//            nB++;
//        }
//        nr.pp();
...
//        }
//        if (el == "boot")
//        { s3.sj("Boot, isRunning" + nv.s0); nv.mO = 0; if (!nv.s0) s3.sh(nv, 0); return true; }
//        if (el.StartsWith
//("scroll"))
//        { t2 em = new t2(no, this, ek); s3.sh(em, 0); return true; }
//        return false;
//    }
//}
//public class t7
...
//ToString();
//        et = et.Substring(et.LastIndexOf('_') + 1);
//        return es.Content.SubtypeName + " " + et;
//    }
...
//= MMItems.pL(eB, eC);
//        if (eD != null)
//        { if (eD.pP != "") return eD.pP; return eD.pM; }
...
//        var eG = eE.ToLower();
//        tg eH;
//        if (MMItems.pK.TryGetValue(
//eG, out eH))
//        { eE = eH.pM; eF = eH.pN; return; }
//        eH = MMItems.pL(eE, eF);
//        if (eH != null)
//        { eE = eH.pM; if (eF == "Ore" || eF == "Ingot") return; eF = eH.pN; }
//    }
...
//eL = " kMGTPEZY";
//        double eM = eI;
//        int eN = eL.IndexOf(eK);
//        int eO = (eN < 0 ? 0 : eN);
//        while (eM >= 1000 && eO + 1 < eL.Length)
//        { eM /= 1000; eO++; }
//        var eP = Math.
//Round(eM, 1, MidpointRounding.AwayFromZero).ToString();
//        if (eO > 0)
//            eP += " " + eL[eO];
//        return eP;
//    }
...
//    {
//        if (ol.StartsWith("inventory") || ol == "missing" || ol.StartsWith("invlist"))
//            return t9.nV;
//        if (ol.
//StartsWith("cargo"))
//            return t9.nW;
//        if (ol.StartsWith("mass"))
//            return t9.nX;
//        if (ol.StartsWith("shipmass"))
//            return t9.of;
//        if (ol == "oxygen")
//            return t9.nY;
//        if (ol.StartsWith("tanks"))
//            return t9.nZ;
//        if (ol.StartsWith("powertime"))
//            return t9.n_;
//        if (ol.StartsWith("powerused"))
//            return t9.o0;
//        if (ol.StartsWith("power"))
//            return t9.o1;
//        if (ol.StartsWith("speed"))
//            return t9.o2;
//        if (ol.StartsWith("accel"))
//            return t9.o3;
//        if (ol.StartsWith("alti"))
//            return t9.oh;
//        if (ol.StartsWith("charge"))
//            return t9.o4;
//        if (ol.StartsWith("time") || ol.StartsWith("date"))
//            return t9.o5;
//        if (ol.StartsWith("countdown"))
//            return t9.o6;
//        if (ol == "echo" || ol == "center" || ol == "right")
//            return t9.nU;
//        if (ol.StartsWith(
//"textlcd"))
//            return t9.o7;
//        if (ol.EndsWith("count"))
//            return t9.o8;
//        if (ol.StartsWith("dampeners") || ol.StartsWith("occupied"))
//            return t9.o9
//;
//        if (ol.StartsWith("working"))
//            return t9.oa;
//        if (ol.StartsWith("damage"))
//            return t9.ob;
//        if (ol.StartsWith("amount"))
//            return t9.oc;
//        if (ol.
//StartsWith("pos"))
//            return t9.od;
//        if (ol.StartsWith("distance"))
//            return t9.og;
//        if (ol.StartsWith("details"))
//            return t9.oe;
//        if (ol.StartsWith
//("stop"))
//            return t9.oi;
//        if (ol.StartsWith("gravity"))
//            return t9.oj;
//        return 0;
//    }
...
//                return true;
//            int eU = on.IndexOf(' ');
//            if (eU < 0 || eU >= on.Length - 1)
//                oo = "";
//            else
//                oo = on.Substring(eU + 1);
//            ot = on.Split(
//' ');
//            ou = "";
//            ov = false;
...
//            }
//            if (eV[0] == '{')
//            { ov = true; ou = eV.Substring(1); continue; }
//            if (eV[eV.Length - 1] == '}')
//            {
//                ov = false;
//                ou += ' ' + eV.Substring(0, eV.Length - 1
//);
//                if (om == "")
//                    om = ou;
//                else
...
//            }
//            if (ov)
//            { if (ou.Length != 0) ou += ' '; ou += eV; continue; }
//            if (om == "")
//                om = eV;
//            else
//                os.Add(
...
//    public void oC()
//    {
//        if (oA == "" || oy != "" || oz != "" || oB.Count > 0)
//            return;
//        var eX = oA.Trim();
//        if (eX[0] == '+' || eX[0] == '-')
//        { oy += eX[0]; eX = oA.Substring(1); }
//        string[] eY = eX.Split('/');
//        var eZ = eY[0];
//        if (eY.Length > 1)
//        { oz = eY[0]; eZ = eY[1]; }
...
//            oz = "";
//        if (eZ.Length > 0)
//        { string[] e_ = eZ.Split(','); for (int f0 = 0; f0 < e_.Length; f0++) if (e_[f0] != "") oB.Add(e_[f0]); }
//    }
//}
//public class tc
//: tp
...
//            o_.Clear();
//            s3.sf.
//GridTerminalSystem.GetBlocksOfType<IMyShipController>(o_);
//            p0 = 0;
//            if (oW != null && oW.CubeGrid.GetCubeBlock(oW.Position) != oX)
//                oW = null;
//        }
//        if (
//o_.Count > 0)
...
//                if (!s3.sp(20))
//                    return false;
//                IMyShipController f3 = o_[p0] as IMyShipController;
//                if (f3.GetValueBool(
//"MainCockpit") || f3.IsUnderControl)
//                {
//                    oW = f3;
//                    oX = f3.CubeGrid.GetCubeBlock(f3.Position);
//                    if (f3.GetValueBool("MainCockpit"))
//                    {
//                        p0 = o_.Count;
//                        break;
//                    }
...
//            }
//            if (oW == null)
//            { oW = o_[0] as IMyShipController; oX = oW.CubeGrid.GetCubeBlock(oW.Position); }
//            oP = oW.CalculateShipMass();
//            if (!oW.
//TryGetPlanetElevation(MyPlanetElevation.Sealevel, out oS))
//                oS = double.NaN;
//            if (!oW.TryGetPlanetElevation(MyPlanetElevation.Surface, out
//oU))
//                oU = double.NaN;
//            oD = oW.GetShipVelocities();
//        }
//        double f4 = oG;
//        oG = oE.Length();
//        oI = (oG - f4) / rZ;
...
//            if (!p1.sp(4))
//                return Double.NaN;
//            IMyInventory fa = p5[p6].GetInventory(0);
//            if (fa == null)
//                continue;
//            f7 += (double)fa.
//CurrentVolume;
//            f8 += (double)fa.MaxVolume;
//        }
//        f7 *= 1000;
//        f8 *= 1000;
//        return (f8 > 0 ? f7 / f8 * 100 : 100);
//    }
...
//            pb = 0;
//        while (pb < p5.Count)
//        { if (!p1.sp(4)) return false; if (p5[pb].CubeGrid != p3) { p5.RemoveAt(pb); continue; } pb++; }
//        return true;
//    }
//    List<
...
//        var fi = (fh >= 1 && fh <= 2 ?
//ff.Substring(0, fh) : "");
//        var fj = fi.Contains("T");
//        if (fi != "")
//            ff = ff.Substring(fh + 1);
//        if (ff == "" || ff == "*")
//        {
//            if (!fg)
//            {
...
//        {
//            if (!fg)
//            { pd.Clear(); p4.GetBlockGroups(pd); pe = 0; }
//            for (; pe < pd.Count; pe++)
//            {
//                IMyBlockGroup fm = pd[pe];
//                if (fm.Name
//.ToLower() == fl)
//                { if (!fg) fm.GetBlocks(p5); if (fj) if (!pc(fg)) return false; return true; }
//            }
//            return true;
//        }
//        if (!fg)
//            p4.SearchBlocksOfName(ff,
//p5);
//        if (fj)
//            if (!pc(fg))
//                return false;
...
//        {
//            pg.Clear();
//            p4.GetBlockGroups(pg)
//;
//            pi = 0;
//        }
//        for (; pi < pg.Count; pi++)
//        {
//            IMyBlockGroup fr = pg[pi];
//            if (fr.Name.ToLower() == fo)
//            {
//                if (!fq)
//                { pj = 0; ph.Clear(); fr.GetBlocks(ph); }
//                else
//                    fq =
//false;
//                for (; pj < ph.Count; pj++)
//                { if (!p1.sp(6)) return false; if (fp && ph[pj].CubeGrid != p3) continue; if (p2.pz(ph[pj], fn)) p5.Add(ph[pj]); }
//                return true;
//            }
//        }
//        return true;
...
//    {
//        int fv = ft.IndexOf(':');
//        var fw = (fv >= 1 && fv <= 2 ? ft.Substring(0, fv) : "");
//        var fx = fw.Contains("T");
//        if (fw != "")
//            ft = ft.Substring(fv + 1);
//        if (
//!fu)
//        { pl.Clear(); pm = 0; }
//        var fy = (fw.Contains("G") ? ft.Trim().ToLower() : "");
//        if (fy != "")
//        { if (!pk(fs, fy, fx, fu)) return false; return true; }
//        if
//(!fu)
//            p2.py(ref pl, fs);
//        if (ft == "" || ft == "*")
//        { if (!fu) p5.AddList(pl); if (fx) if (!pc(fu)) return false; return true; }
//        for (; pm < pl.Count; pm++)
//        {
//            if (!p1.sp(4))
//                return false;
//            if (fx && pl[pm].CubeGrid != p3)
//                continue;
//            if (pl[pm].CustomName.Contains(ft))
//                p5.Add(pl[pm]);
//        }
//        return true;
//    }
...
//            return;
//        pv = new Dictionary<string, Action<List<IMyTerminalBlock>, Func<IMyTerminalBlock, bool>>>(){{"CargoContainer",pt.GetBlocksOfType
...
//    {
//        Action<List<IMyTerminalBlock>, Func<IMyTerminalBlock, bool>> fD = null;
//        if (pv.TryGetValue(fC, out fD)
//)
//            fD(fB, null);
//        else
//        {
...
//;
//            default:
//                return fH.BlockDefinition.ToString().Contains(pA(fI));
//        }
//    }
...
//        fK = fK.ToLower();
//        if (fK.StartsWith(
//"carg") || fK.StartsWith("conta"))
//            return "CargoContainer";
//        if (fK.StartsWith("text") || fK.StartsWith("lcd"))
//            return "TextPanel";
//        if (fK.
//StartsWith("ass"))
//            return "Assembler";
//        if (fK.StartsWith("refi"))
//            return "Refinery";
//        if (fK.StartsWith("reac"))
//            return "Reactor";
//        if (fK.
//StartsWith("solar"))
//            return "SolarPanel";
//        if (fK.StartsWith("bat"))
//            return "BatteryBlock";
//        if (fK.StartsWith("bea"))
//            return "Beacon";
//        if (
//fK.Contains("vent"))
//            return "AirVent";
//        if (fK.Contains("sorter"))
//            return "ConveyorSorter";
//        if (fK.Contains("tank"))
//            return "OxygenTank";
//        if (fK.Contains("farm") && fK.Contains("oxy"))
//            return "OxygenFarm";
//        if (fK.Contains("gene") && fK.Contains("oxy"))
...
//        if (fK == "laserantenna")
//            return "LaserAntenna";
//        if (fK.Contains("antenna"))
//            return
//"RadioAntenna";
//        if (fK.StartsWith("thrust"))
//            return "Thrust";
//        if (fK.StartsWith("gyro"))
//            return "Gyro";
//        if (fK.StartsWith("sensor"))
//            return
//"SensorBlock";
//        if (fK.Contains("connector"))
//            return "ShipConnector";
//        if (fK.StartsWith("reflector"))
//            return "ReflectorLight";
//        if ((fK.
//StartsWith("inter") && fK.EndsWith("light")))
//            return "InteriorLight";
//        if (fK.StartsWith("land"))
//            return "LandingGear";
//        if (fK.StartsWith(
//"program"))
//            return "ProgrammableBlock";
//        if (fK.StartsWith("timer"))
//            return "TimerBlock";
//        if (fK.StartsWith("motor"))
//            return "MotorStator"
//;
//        if (fK.StartsWith("piston"))
//            return "PistonBase";
//        if (fK.StartsWith("proj"))
//            return "Projector";
//        if (fK.Contains("merge"))
//            return
//"ShipMergeBlock";
//        if (fK.StartsWith("sound"))
//            return "SoundBlock";
//        if (fK.StartsWith("col"))
//            return "Collector";
//        if (fK.Contains("jump"))
//            return "JumpDrive";
//        if (fK == "door")
//            return "Door";
//        if ((fK.Contains("grav") && fK.Contains("sphe")))
//            return "GravityGeneratorSphere";
//        if (fK
//.Contains("grav"))
//            return "GravityGenerator";
//        if (fK.EndsWith("drill"))
//            return "ShipDrill";
//        if (fK.Contains("grind"))
//            return
//"ShipGrinder";
//        if (fK.EndsWith("welder"))
//            return "ShipWelder";
//        if ((fK.Contains("turret") && fK.Contains("gatl")))
//            return
//"LargeGatlingTurret";
//        if ((fK.Contains("turret") && fK.Contains("inter")))
//            return "LargeInteriorTurret";
//        if ((fK.Contains("turret") && fK.
//Contains("miss")))
//            return "LargeMissileTurret";
//        if (fK.Contains("gatl"))
//            return "SmallGatlingGun";
//        if ((fK.Contains("launcher") && fK.
//Contains("reload")))
//            return "SmallMissileLauncherReload";
//        if ((fK.Contains("launcher")))
...
//        if (fK == "warhead")
//            return "Warhead";
//        if (fK.StartsWith("func"))
//            return "FunctionalBlock";
//        if (fK == "shipctrl"
//)
//            return "ShipController";
//        if (fK.StartsWith("light"))
//            return "LightingBlock";
//        if (fK.StartsWith("contr"))
//            return "ControlPanel";
//        if (fK.
//StartsWith("coc"))
//            return "Cockpit";
//        if (fK.StartsWith("medi"))
//            return "MedicalRoom";
//        if (fK.StartsWith("remote"))
//            return "RemoteControl"
//;
//        if (fK.StartsWith("but"))
//            return "ButtonPanel";
//        if (fK.StartsWith("cam"))
//            return "CameraBlock";
//        if (fK.Contains("detect"))
//            return
//"OreDetector";
//        return "Unknown";
//    }
...
//        var fN = new
//List<double>();
//        string[] fO = fL.DetailedInfo.Split('\n');
//        int fP = Math.Min(fO.Length, (fM > 0 ? fM : fO.Length));
//        for (int fQ = 0; fQ < fP; fQ++)
//        {
//            string[] fR = fO[fQ].Split(':');
//            if (fR.Length < 2)
//            { fR = fO[fQ].Split('r'); if (fR.Length < 2) fR = fO[fQ].Split('x'); }
//            var fS = (fR.Length < 2 ? fR[0] :
//fR[1]);
//            string[] fT = fS.Trim().Split(' ');
//            var fU = fT[0].Trim();
//            var fV = (fT.Length > 1 && fT[1].Length > 1 ? fT[1][0] : '.');
//            double fW;
//            if (Double.
//TryParse(fU, out fW))
//            { double fX = fW * Math.Pow(1000.0, ".kMGTPEZY".IndexOf(fV)); fN.Add(fX); }
//        }
//        return fN;
//    }
...
//    {
//        var fZ = "";
//        if (fY.GetValueBool("Recharge"))
//            fZ = "(+) ";
//        else if (fY.GetValueBool("Discharge"))
//            fZ = "(-) ";
//        else
//            fZ =
//"(±) ";
...
//    {
//        var ga = "udoesnp";
//        string[] gb = g9.DetailedInfo.Split('\n');
//        var gc = gb[gb.Length
//- 1];
//        string[] gd = gc.Split(':');
//        string ge;
//        if (gd.Length < 2)
//        {
//            ge = gd[0].Trim().ToLower();
//            if (ge.StartsWith("slot status"))
//                ge = ge.Substring(
//11);
//        }
//        else
//            ge = gd[1].Trim().ToLower();
//        if (ge == "")
//            return M.T["W8"];
//        if (ge.Split(' ').Length > 1)
//            return M.T["W10"];
//        if ((ga.IndexOf(ge[0]) < 0
//) && !ge.StartsWith("au"))
//            return M.T["W7"];
//        return M.T["W8"];
//    }
...
//            gg = "AmmoMagazine";
//        else if (gg == "Tool")
//            gg = "PhysicalGunObject";
//        var gl = gf + ' ' + gg;
//        tg gm = new tg(gf, gg,
//gh, gi, gj, gk);
//        pH.Add(gl, gm);
//        if (!pI.ContainsKey(gf))
//            pI.Add(gf, gm);
//        if (gj != "")
//            pK.Add(gj.ToLower(), gm);
//        pJ.Add(gl);
//    }
//    public static tg pL(
//string gn = "", string go = "")
//    {
//        if (pH.ContainsKey(gn + " " + go))
//            return pH[gn + " " + go];
//        if (go == "")
//        {
//            tg gp = null;
//            pI.TryGetValue(gn, out gp);
//            return gp;
//        }
//        if (gn == "")
//            for (int gq = 0; gq < pH.Count; gq++)
//            { tg gp = pH[pJ[gq]]; if (go == gp.pN) return gp; }
//        return null;
//    }
//}
//public class tg
...
//;
//        var gF = "";
//        ti gG = new ti(gB, gC, gD);
//        if (gE.Length == 2)
//        { if (!pS.TryGetValue(gE[1], out gF)) gF = gE[1]; }
//        var gH = gE[0];
//        if (pS.TryGetValue(gH,
//out gG.qc))
//        { pV.qh(gG.qc, gG); return; }
//        t8.nP(ref gH, ref gF);
//        if (gF == "")
//        { gG.qb = gH.ToLower(); pU.qh(gG.qb, gG); return; }
//        gG.qb = gH;
//        gG.qc = gF;
...
//        ti gU = new ti();
//        gR = gR.ToLower();
//        ti gV = q0(gR, gS.ToLower(), gT.
//ToLower());
//        if (gV != null)
//        { gU.q9 = gV.q9; gU.qa = gV.qa; }
//        gU.qb = gS;
//        gU.qc = gT;
//        pY.qh(gR, gU);
//        return gU;
...
//                return null;
//            ti h1 = pY.qk(q4);
//            if (q1((h1.qb + ' ' + h1.qc).ToLower(), h1.qb
//, h1.qc))
//                continue;
//            if (h1.qc == g_)
//                q5.Add(h1);
...
//            if (!pT.sp(10))
//                return false;
//            tg h3 = MMItems.pH[MMItems.pJ[q7]];
//            if (!h3.pR)
//                continue;
//            var h4 = h3.pM + ' ' + h3.pN;
//            if (q1(h4, h3.pM, h3.pN))
//                continue;
//            ti h5 = q3(h4, h3.pM, h3.pN);
//            if (h5.qa == -1)
//                h5.qa = h3.pO;
//        }
//        return true;
...
//hm;
//        MyResourceSourceComponent hn;
//        for (; qr < he.Count; qr++)
//        {
//            if (!qn.sp(8))
//                return false;
//            if (he[qr].Components.TryGet<
//MyResourceSinkComponent>(out hm))
//            { hf += hm.CurrentInputByType(qo); hg += hm.MaxRequiredInputByType(qo); }
//            if (he[qr].Components.TryGet<
//MyResourceSourceComponent>(out hn))
//            { hh += hn.CurrentOutputByType(qo); hi += hn.MaxOutputByType(qo); }
//            hj += (he[qr] as IMyBatteryBlock).
//CurrentStoredPower;
//            hk += (he[qr] as IMyBatteryBlock).MaxStoredPower;
//        }
//        return true;
//    }
...
//        if (!hu)
//            qt = 0;
//        MyResourceSinkComponent hv;
//        MyResourceSourceComponent hw;
//        for (; qt < ho.Count; qt++)
//        {
//            if (!qn.sp(6))
//                return false;
//            if (ho[qt].Components.TryGet<MyResourceSinkComponent>
//(out hv))
//            { hq += hv.CurrentInputByType(hp); hr += hv.MaxRequiredInputByType(hp); }
//            if (ho[qt].Components.TryGet<MyResourceSourceComponent>(
//out hw))
//            { hs += hw.CurrentOutputByType(hp); ht += hw.MaxOutputByType(hp); }
//        }
//        return true;
//    }
...
//        if (!hB)
//        { qv = 0; hA = 0; hz = 0; }
//        MyResourceSinkComponent hC;
//        for (; qv < hx.
//Count; qv++)
//        {
//            if (!qn.sp(30))
//                return false;
//            IMyGasTank hD = hx[qv] as IMyGasTank;
//            if (hD == null)
//                continue;
//            double hE = 0;
//            if (hD.Components.TryGet<
//MyResourceSinkComponent>(out hC))
//            {
//                ListReader<MyDefinitionId> hF = hC.AcceptedResources;
//                int hG = 0;
//                for (; hG < hF.Count; hG++)
//                {
//                    if (hF[hG].
//SubtypeId.ToString().ToLower() == hy)
//                    { hE = 100; hA += hE; hz += hE * hD.FilledRatio; break; }
//                }
//            }
//        }
//        return true;
...
//    {
//        for (
//int hK = 0; hK < qy.qO(); hK++)
//            qy.qQ(hK).SetValueFloat("FontSize", hJ);
//    }
//    public void qH()
//    {
//        qy.qS();
//        qA = qy.qQ(0);
//        int hL = qA.CustomName.IndexOf
//("!MARGIN:");
//        if (hL < 0 || hL + 8 >= qA.CustomName.Length)
//        { qB = 1; qC = " "; }
//        else
//        {
//            var hM = qA.CustomName.Substring(hL + 8);
//            int hN = hM.IndexOf(" ");
//            if
//(hN >= 0)
//                hM = hM.Substring(0, hN);
//            if (!int.TryParse(hM, out qB))
//                qB = 1;
//            qC = new String(' ', qB);
//        }
//        if (qA.CustomName.Contains("!NOSCROLL"))
//            qE =
//false;
//        else
//            qE = true;
...
//        if (qz == null || qA == null)
//            return;
//        float hO = qA.GetValueFloat("FontSize");
//        for (int hP = 0; hP < qy.qO();
//hP++)
//        {
//            IMyTextPanel hQ = qy.qQ(hP);
//            if (hP > 0)
//                hQ.SetValueFloat("FontSize", hO);
//            hQ.WritePublicText(qz.rR(hP));
//            if (qx.r0)
//                hQ.
//ShowTextureOnScreen();
//            hQ.ShowPublicTextOnScreen();
//        }
//    }
//}
//public class tm
...
//i0 = h_.qA;
//        if (hZ == null)
//            hZ = new to(this, i0.GetValueFloat("FontSize"));
//        else
//            hZ.rI(i0.GetValueFloat("FontSize"));
//        hZ.rJ(h_.qy.qO());
//        hZ.rA
//= (h_.qI() ? 2.0f : 1.0f) * r2 / hZ.rz;
//        r9 = h_.qC;
//        r8 = h_.qB;
//        rj = hZ;
//        return hZ;
...
//        }
//        id -= ic;
//        int ie = (int)Math.Floor(id / r5);
//        float ig = ie * r5;
//        rj.rK(new String(' ', ie) + i9);
//        rj.rH += ig + ic;
//    }
//    public
//void rr(string ih)
...
//        }
//        ik -= ij / 2;
//        int il = (int)Math.Round(ik / r5, MidpointRounding.AwayFromZero);
//        float im = il * r5;
//        rj.rK(new String(' ', il) + ii);
//        rj
//.rH += im + ij;
//    }
...
//    {
//        if (r8 > 0)
//            iq += r8 * r5 * ((rj.rH <= 0) ? 2 : 1);
//        float ir = qV * ip * rj.rA - rj.rH - iq;
//        if (Double.IsNaN(io))
//            io = 0;
//        int it = (int)(ir / r6) - 2;
//        if (it <= 0)
//            it = 2;
//        int iu = Math.Min((int)(io * it) / 100, it);
//        if (iu < 0)
//            iu = 0;
//        rj.rO((rj.rH <= 0 ? r9 :
...
//            ix += r8 * r5 * ((rj
//.rH <= 0) ? 2 : 1);
//        float iy = qV * iw * rj.rA - rj.rH - ix;
//        if (Double.IsNaN(iv))
//            iv = 0;
//        int iz = (int)(iy / r6) - 2;
//        if (iz <= 0)
//            iz = 2;
//        int iA = Math.Min((int)(iv *
//iz) / 100, iz);
//        if (iA < 0)
//            iA = 0;
//        rj.rK((rj.rH <= 0 ? r9 : "") + "[" + new String('|', iA) + new String('\'', iz - iA) + "]");
//        rj.rH += (rj.rH <= 0 ? r8 * r5 : 0) + r6 * iz
//+ 2 * r7;
//    }
...
//    {
//        IMyTextPanel
//iE = rb.GridTerminalSystem.GetBlockWithName(iC) as IMyTextPanel;
//        if (iE == null)
//            return;
//        iE.WritePublicText(iD + "\n", true);
//    }
//}
//public class to
//{
...
//    {
//        rz = iH;
//        rB = (int)Math.Floor(512 / 0.7783784f * ry.r3 * rE / rz / 37);
//    }
//    public void rJ(int iI)
//    {
//        rE = iI;
//        rB = (int)Math.Floor(512 / 0.7783784f * ry.r3 * rE /
//rz / 37);
//    }
...
//    {
//        if (rF.Count < rB / rE)
//        { if (iQ != 0) return ""; rC = 0; rD = 1; return rQ(); }
//        int iR = rC + iQ * (rB / rE);
//        if (iR > rF.Count)
//            iR = rF.Count;
//        List<string> iS = rF.GetRange(iR, Math.Min(rF.Count - iR, rB / rE));
//        return String.Join("\n", iS);
//    }
...
//        if (rC + iU + rB >=
//iV)
//        { rC = Math.Max(iV - rB, 0); return true; }
//        rC += iU;
//        return false;
//    }
...
//        if (
//rY > 0)
//        { rZ = s3.sb - rY; s3.sj((s1 ? "Running" : "Resuming") + " task: " + rW); s1 = Run(!s1); }
//        else
//        {
//            rZ = 0;
//            s3.sj("Init task: " + rW);
...
//        }
//        if (s1)
//        { rY = s3.sb; if ((r_ >= 0 || s2 > 0) && s0) s3.sh(this, (s2 > 0 ? s2 : r_)); else { s0 = false; rY = 0; } }
//        else
//        { if (s0) s3.sh(this, 0, true); }
//        s3.sj("Task " + (s1 ? "" : "NOT ") + "finished. " + (s0 ? (s2 > 0 ? "Postponed by " + s2.ToString("F1") + "s" :
//"Scheduled after " + r_.ToString("F1") + "s") : "Stopped."));
//        s2 = 0;
//        return s1;
//    }
...
//        j0.s4(this);
//        if (j2)
//        { j0.rX = sb; se.Insert(0, j0); return; }
//        if (j1 <= 0)
//            j1 = 0.001;
//        j0.rX = sb + j1;
//        for (int j3 = 0; j3 < se
//.Count; j3++)
//        { if (se[j3].rX > j0.rX) { se.Insert(j3, j0); return; } if (j0.rX - se[j3].rX < 0.05) j0.rX = se[j3].rX + 0.05; }
//        se.Add(j0);
//    }
//    public void si
//(tp j4)
...
//        sd += j6;
//        sj("Total time: " + sd.ToString("F1") + " Time Step: " + j6.ToString("F2"));
//        sc = (int)Math.
//Min((j6 * 60) * 1000, 20000 - 1000);
//        sj("Total tasks: " + se.Count + " InstrPerRun: " + sc);
//        while (se.Count >= 1)
//        {
//            tp j7 = se[0];
//            if (sc - sf.Runtime.
...
//            if (!j7.s6())
//                break;
//            sj("Done. NextExecTime: " + j7.rX.ToString("F1"))
//;
...
//        if (sl == 5000)
//        {
//            IMyTextPanel j9 = sf.GridTerminalSystem.GetBlockWithName("AUTOLCD Profiler") as IMyTextPanel;
//            if (j9 ==
//null)
//                return;
//            j9.WritePublicText(sm.ToString());
//            sl++;
//            return;
//        }
//        sm.Append(sl).Append(";").AppendLine(j8.ToString("F2"));
//        sl++;
//    }
//    public
//int so()
